export default {
    settings: {
      ...
      registration: {
        ...
        affiliateCodeRegistration: '允许使用返利邀请码注册',
        affiliateCodeRegistrationHint: '开启后，有效的返利邀请码或邀请链接也可满足邀请码注册要求',
        affiliateCodeRegistrationRequiresAffiliate: '需要先开启邀请返利功能',
        passwordReset: '忘记密码',
      ...
      site: {
        ...
        siteDomain: '站点域名',
        siteDomainHint: '仅填写域名，不包含 http:// 或 https://。配置后，其他域名的页面请求将以 307 跳转到此域名，站内 API 将返回 403；AI API 不受影响。留空则保持现有访问方式',
        ...
        contactQRImage: '客服二维码图片',
        contactQRImageHint: '上传客服二维码，将直接展示在右上角的“联系客服”下方',
        docUrl: '文档链接',

		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyOIDCConnectSkipActionCaptcha:    "false",
					...
					service.SettingKeySiteDomain:        "ai.example.com",
					service.SettingKeyAPIBaseURL:        "https://api.example.com",
					service.SettingKeyContactInfo:       "support",
					service.SettingKeyContactQRImageURL: "https://example.com/support-qr.png",
			...
			wantJSON: `{
				...
				"data": {
					...
					"aliyun_captcha_region": "cn",
						...
						"site_domain": "ai.example.com",
						"api_base_url": "https://api.example.com",
						"api_key_acl_trust_forwarded_ip": false,
						"forwarded_client_ip_headers": [],
						"contact_info": "support",
						"contact_qr_image_url": "https://example.com/support-qr.png",

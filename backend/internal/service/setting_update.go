...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyAffiliateCodeRegistrationEnabled] = strconv.FormatBool(settings.AffiliateCodeRegistrationEnabled)
	...
	updates[SettingKeyOIDCConnectSkipActionCaptcha] = strconv.FormatBool(settings.OIDCConnectSkipActionCaptcha)
	...
	updates[SettingKeyContactQRImageURL] = settings.ContactQRImageURL

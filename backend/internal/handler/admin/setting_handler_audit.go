...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.AffiliateCodeRegistrationEnabled != after.AffiliateCodeRegistrationEnabled {
		changed = append(changed, "affiliate_code_registration_enabled")
	}
	...
	if before.SiteDomain != after.SiteDomain {
		changed = append(changed, "site_domain")
	}
	...
	if before.ContactQRImageURL != after.ContactQRImageURL {
		changed = append(changed, "contact_qr_image_url")
	}

...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	codexTurnStateDegradedHandler := admin.NewCodexTurnStateDegradedHandler(db)
	codexTurnStatePanelHandler := admin.NewCodexTurnStatePanelHandler(codexTurnStateDegradedHandler)
